...
class GlobalNewsRssTool(BaseTool):
    ...
    description: str = "Global News RSS Tool. Collects news articles from major international RSS feeds."
    args_schema: Type[BaseModel] = GlobalNewsRssToolInput

    def _run(self, each: int = 10):
        global_rss_feeds = NewsFeedConfig(
            feeds={
        ...
        return _get_rss(global_rss_feeds.feeds, each)
...
class KoreanNewsRssTool(BaseTool):
    ...
    def _run(self, each: int = 10):
        korean_rss_feeds = NewsFeedConfig(
            feeds={
        ...
        return _get_rss(korean_rss_feeds.feeds, each)
...
class WebSearchTool(BaseTool):
    ...
    description: str = "Web Content Scraper Tool. This tool scrapes the content of a specific URL and returns it in text format."
    ...
    def _run(self, url: str):
        try:
            ...
            result = ScrapeResult(title=title, url=url, content=content)
